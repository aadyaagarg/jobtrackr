...
public class JobController {
    ...
    @PostMapping
    public ResponseEntity<String> addJob(@RequestBody CreateJobRequest jobRequest) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<String> updateJob(@PathVariable Long id, @RequestBody CreateJobRequest jobRequest) {
